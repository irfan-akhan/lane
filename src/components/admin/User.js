...
const CreateUser = () => {
  ...
  useEffect(() => {
    fetch("https://shuttlelaneee.herokuapp.com/api/users")
  ...
  const deleteUserHandler = (id) => {
    try {
      ...
      fetch(`https://shuttlelaneee.herokuapp.com/api/users/${id}`, {
        method: "DELETE",
        headers: {
  ...
  const onSubmitHandler = (e) => {
    ...
    fetch("https://shuttlelaneee.herokuapp.com/api/signup", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",

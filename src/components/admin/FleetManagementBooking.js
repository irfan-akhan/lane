...
const FleetManagementBooking = () => {
  ...
  useEffect(() => {
    fetch("https://shuttlelaneee.herokuapp.com/api/booking/fleet")
                ...
                return (
                  <tr>
                    ...
                    <td>
                      ...
                      <p>
                        <strong>Email: </strong> {fleet.bookingEmail}
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        {fleet.openHours == true ? "Yes" : "No"}
                      </p>
                    </td>
                    <td>
                      <p>
                        <strong>Size: </strong> {fleet.fleetSize}
                      </p>
                      <p style={{ width: "200px" }}>
                        <strong>Type: </strong>
                        {fleet.vehicleType}
                      ...
                      <p>
                        ...
                        {fleet.operatingHours == true ? "Yes" : "No"}
                      </p>
                      <p>

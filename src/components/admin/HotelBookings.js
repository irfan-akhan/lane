          ...
          <table className={styles.table}>
            <thead style={{ backgroundColor: "red" }}>
              <tr className={styles.theading}>
                ...
                <th style={{ textAlign: "start" }}>Booking reference</th>
                <th style={{ textAlign: "start" }}>Contact</th>
                <th style={{ textAlign: "start" }}>Hotel Details</th>
                <th style={{ textAlign: "start" }}>Booking Date</th>
                <th style={{ textAlign: "start" }}>Service Status</th>
              </tr>
            </thead>
